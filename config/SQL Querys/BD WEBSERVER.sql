...
IF NOT EXISTS (SELECT * FROM INFORMATION_SCHEMA.TABLES WHERE TABLE_NAME = 'CAT_TAGS_TIPO_BIBLIA')
CREATE TABLE CAT_TAGS_TIPO_BIBLIA (
    ID INT IDENTITY(1,1) PRIMARY KEY,
    TIPO_TAG NVARCHAR(50),


);
GO

IF NOT EXISTS (SELECT * FROM INFORMATION_SCHEMA.TABLES WHERE TABLE_NAME = 'CAT_TAGS_BIBLIA')
CREATE TABLE CAT_TAGS_BIBLIA (
    ID INT IDENTITY(1,1) PRIMARY KEY,
    TIPO_TAG_ID INT,
	TAG NVARCHAR(50)
...
IF NOT EXISTS (SELECT * FROM INFORMATION_SCHEMA.TABLES WHERE TABLE_NAME = 'DAT_TAGS_BIBLIA')
CREATE TABLE DAT_TAGS_BIBLIA (
    ID INT IDENTITY(1,1) PRIMARY KEY,
    LIBRO_ID INT,
    VERSICULO INT,
	TAG_TIPO_ID INT,
